...
@router.post("/aspects", summary="Sinastri Açıları", response_model=List[Dict[str, Any]])
def get_synastry_aspects(charts: Dict[str, Any] = Depends(get_synastry_charts_dependency)):
    try:
        p1_planets = charts['p1_data']['planets']
